...
import type { AnalyticsMapping } from "./mappings";
          ...
          <CardContent className="flex flex-col gap-2 py-4 text-sm">
            ...
            <div className="mt-2 grid grid-cols-2 gap-3">
              <div>
                ...
                <div className="text-lg font-semibold">{state.data.metrics.activeUsers}</div>
              </div>
              <div>
                <div className="text-xs text-muted-foreground">Sessions</div>
                <div className="text-lg font-semibold">{state.data.metrics.sessions}</div>
              </div>
              <div>
                <div className="text-xs text-muted-foreground">Engaged sessions</div>
                <div className="text-lg font-semibold">{state.data.metrics.engagedSessions}</div>
              </div>
              <div>
                <div className="text-xs text-muted-foreground">Key events</div>
                <div className="text-lg font-semibold">{state.data.metrics.keyEvents}</div>
              </div>
            </div>
          </CardContent>
        </Card>
